...
using ServicesPlatform.SyncDataServices.Grpc;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            if(_env.IsProduction())
           {
            ...
            {
                System.Console.WriteLine("--> Using InMemm Db");
                 services.AddDbContext<AppDbContext>(opt => opt.UseInMemoryDatabase("InMem"));
            }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ServicesPlatform v1"));
            }
           ...
           // app.UseHttpsRedirection();
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapGrpcService<GrpcServicesPlatform>();

                // Serves Proto file to client
